...
//        {
//            //locales
//            this.AddOrUpdatePluginLocaleResource("Plugins.SaleOfTheDay.Fields.CustomerRole", "Required customer role");
//            this.AddOrUpdatePluginLocaleResource("Plugins.SaleOfTheDay.Fields.CustomerRole.Hint", "Discount will be applied if customer is in the selected customer role.");
//            this.AddOrUpdatePluginLocaleResource("Plugins.SaleOfTheDay.Fields.CustomerRole.Select", "Select customer role");
...
//            //locales
//            this.DeletePluginLocaleResource("Plugins.SaleOfTheDay.Fields.CustomerRole");
//            this.DeletePluginLocaleResource("Plugins.SaleOfTheDay.Fields.CustomerRole.Hint");
//            this.DeletePluginLocaleResource("Plugins.SaleOfTheDay.Fields.CustomerRole.Select");
